...
export function createSeedData(): AppData {
  ...
  const customers = [
    ...
    { id: 'c-abc', name: 'ABC Cafe', phone: '03-2166 4410', email: 'orders@abccafe.my', address: '18, Jalan Bukit Bintang, 55100 Kuala Lumpur', status: 'active' as const },
    { id: 'c-abc-ent', name: 'ABC Enterprise', phone: '03-7788 2210', email: 'purchasing@abcenterprise.my', address: '28, Jalan Kuchai Lama, 58200 Kuala Lumpur', status: 'active' as const },
  ...
  const taskStamp = iso(9, 1, 9)
  const staffTaskCategories = defaultStaffTaskCategories(taskStamp)
  const parcelSale = sales.find((row) => row.invoiceNo === 'INV-001250')
  const staffTasks: StaffTask[] = [
    {
      id: 'tsk-toilet',
      title: 'Bersihkan tandas',
      description: 'Daily washroom cleaning.',
    ...
    {
      id: 'tsk-parcel',
      title: 'Keluarkan parcel',
      description: 'Prepare packed parcels for collection.',
      ...
      photoRequirement: 'none',
      active: true,
      referenceType: parcelSale ? 'invoice' : '',
      referenceId: parcelSale?.id ?? '',
      referenceNo: parcelSale?.invoiceNo ?? 'INV-001250',
      createdBy: 'u-admin',
      createdAt: taskStamp,
      updatedAt: taskStamp,
    },
    {
      id: 'tsk-stor',
      title: 'Susun stor',
      description: 'Tidy and restack the store.',
    ...
    },
    {
      ...
      description: 'Clear the back drain.',
      categoryId: 'tcat-cleaning',
      assignedTo: 'u-kumar',
    ...
    },
    {
      ...
      description: 'Annual feeding machine service.',
