    ...
    <div>
      ...
      <FilterRow>
        ...
        <Select value={type} onChange={(e) => setType(e.target.value)}>
          ...
          {['purchase','sale','sales_return','purchase_return','adjustment','transfer_in','transfer_out','opening_stock','stock_count','production_in','production_out','production_wastage','production_balance_in','production_balance_out','receiving','opening_balance'].map((t) => (
